...
class A_star:
    ...
    def a_star(self, goalx, goaly, startx, starty, rpm1, rpm2, d):
        ...
        while (len(queue_nodes) != 0):
            ...
            if (x, y) not in closed_list:
                ...
                if self.euclidean_distance(node_state_g[0], x, node_state_g[1], y) > 0.15:
                    ...
                    self.create_map(d/10, visited_nodes, back_track, path_dict)
...
def main():
    ...
    velo = astar.a_star(args.goal_x, args.goal_y,
                        args.start_x, args.start_y, args.RPM1, args.RPM2, args.clearance)
    rclpy.init()
